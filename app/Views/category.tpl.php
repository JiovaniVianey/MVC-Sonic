<section class="hero">
  <div class="container">
    ...
    <ol class="breadcrumb justify-content-center">
      ...
      <li class="breadcrumb-item active"><?= $categories[$viewData['categoryId'] - 1]->getName() ?></li>
    </ol>
    <!-- Hero Content-->
    <div class="hero-content pb-5 text-center">
      <h1 class="hero-heading"><?= $categories[$viewData['categoryId'] - 1]->getName() ?></h1>
      <div class="row">
        <div class="col-xl-8 offset-xl-2">
          <p class="lead text-muted"><?= $categories[$viewData['categoryId'] - 1]->getSubtitle() ?></p>
        </div>
      </div>
    </div>
  </div>
